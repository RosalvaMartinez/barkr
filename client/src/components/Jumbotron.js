    ...
    return (
        <div className="flex border border-black rounded-xl p-4 m-6 bg-gradient-to-r from-purple-800 to-blue-700 transition">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl italic dark:text-white">We invest time in your pets health so you dont have to</h1>
