function ActivityForm() {
    return (
        <form className="flex flex-col border border-black rounded-xl w-[300px] p-4 m-6 justify-center bg-gradient-to-r from-slate-800 to-slate-700">
            ...
            <h1 className="text-white font-light text-center text-underline underline">DIET</h1>
            <label className="my-4">
                <input className="rounded w-full p-2" placeholder="current weight" name="name" type="text" />
                <div className="visible h-4 text-red-600">in pounds</div>
            </label>
            <label className="my-4">
                <input className="rounded w-full p-2" placeholder="food intake" name="name" type="text" />
                <div className="visible h-4 text-red-600">in grams</div>
            </label>
